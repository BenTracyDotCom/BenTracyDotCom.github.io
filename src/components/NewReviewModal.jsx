...
export default function NewReviewModal({ id, photo, setPhoto, setDelButton }) {
  ...
  const handleSubmit = () => {
    ...
    validateEmail(form.email)){
      setBadSubmission({});
      handleExit()
      alert("In production, this would have submitted a valid review to the client's API.")
    } else {
        ...
        <div className="text-3xl text-center">Write Your Review</div>
          ...
          <div className="form-control w-full">
            ...
            <div>
              ...
              <input type="text" placeholder="Example: jackson11@email.com" className={`input w-full max-w-xs text-black ${ badSubmission.email && !validateEmail(form.email) ? 'input-error' : 'input-bordered'}`} onChange={handleEmail} />
              <label className="label pt-0 pb-0">
